            ...
            <div className="card rounded-none flex-shrink-0 w-full max-w-sm mx-auto shadow-2xl mt-10">
                <form onSubmit={handleSubmit(handleAddProduct)} className="card-body">
                    <div className="form-control">
                        <input {...register("name", { required: true })} type="text" defaultValue={user?.displayName} readOnly disabled name='name' placeholder="name" className="input input-bordered rounded-none my-3" />
                    </div>
                    <div className="form-control">
                        <input {...register("email", { required: true })} type="email" defaultValue={user?.email} readOnly disabled name='email' placeholder="email" className="input input-bordered rounded-none my-3" />
